...
#' \itemize{
#' \item{\code{dist:}}{ the distance between \code{Graphs1} and \code{Graphs2}.}
...
graph.takahashi.test <- function(Graphs1, Graphs2, maxBoot=1000,dist = "JS",...) {
  if(!valid.input(Graphs1) || !valid.input(Graphs2)) stop("The inputs should be a list of graphs")
  ...
  return(list("distance"=result, "p.value"=pvalue))
}
