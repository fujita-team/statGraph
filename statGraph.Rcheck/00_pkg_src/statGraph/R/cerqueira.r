...
#' \item{\code{reject_threshold:}}{ The \code{1-alpha}-quantile of the test distribution under
#' the null hypothesis.}
#' \item{\code{bootstrap_samples:}}{ The test distribution on the bootstrap resamples.}
#' }
#'
#' @references
#' Andressa Cerqueira, Daniel Fraiman, Claudia D. Vargas and Florencia Leonardi.
